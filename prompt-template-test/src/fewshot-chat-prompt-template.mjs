...
// ew-shot 示例：每条示例是「human 问 + ai 答」的聊天片段
const EXAMPLES = [
    {
...
const main  = async () => {
   try {
       ...
       // [
       //     SystemMessage {
       //     "content": "你是一名资深技术负责人，请根据给定的工作内容，参考上面的示例，帮我写一段结构清晰、重点突出的周报片段（使用 Markdown 列表）。",
       //     "additional_kwargs": {},
       //     "response_metadata": {}
       // },
       //     SystemMessage {
       ...
       // },
       //     AIMessage {
       //     "content": "- 本周围绕支付链路稳定性开展治理工作：完成 1 起 P1 事故与 2 起 P2 事故的排查与修复，均在 SLA 内关闭；\n- 梳理并合并冗余告警规则 8 条，新建 4 条基于 SLO 的告警，大幅降低无效告警噪音；\n- 组织 1 次故障应急演练，验证支付核心链路的应急预案可行性。",
       //     "additional_kwargs": {},
       //     "response_metadata": {},
       //     "tool_calls": [],
       //     "invalid_tool_calls": []
       ...
       // },
       //     HumanMessage {
       //     "content": "这是我本周的实际工作内容，请帮我整理成周报：\n本周完成了订单模块的一轮重构，拆分了历史遗留的大文件，并补齐了核心路径的单测；同时修复了两起线上性能问题，并把指标接入统一监控看板。",
       //     "additional_kwargs": {},
       //     "response_metadata": {}
       // }
       // ]
